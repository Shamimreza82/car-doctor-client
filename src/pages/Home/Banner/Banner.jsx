    ...
    return (
        <div className="carousel h-[600px]">
            <div id="slide1" className="carousel-item relative">
                ...
                <div className='text-white space-y-7 md:w-1/2 pl-4 '>
                    <h2 className='md:text-6xl text-white font-bold'>Affordable Price For Car Servicing</h2>
                    <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                    <button className="btn btn-success md:mr-3 uppercase">Discover More</button>
